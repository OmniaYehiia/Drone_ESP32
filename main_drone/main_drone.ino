...
const int flEscPin = 25; //The PWM Pin on ESP32 
...
//PID constants
const float kp_roll = 1.6, 
            kd_roll = 6,   
            ki_roll = 0.015;

const float kp_pitch = kp_roll,
            kd_pitch = kd_roll,
            ki_pitch = ki_roll;
...
void updateMotor() {
  if (controller_active) {
    ...
    */
    ...
    //write speed after any thing on motors 
...
void readJoystick() {
  ...
  ref_throttle = map(ref_array[0], 0, 200, 1000, 2000);
